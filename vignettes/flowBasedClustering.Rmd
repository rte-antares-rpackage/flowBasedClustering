...
vertices <- ptdfToVertices(PTDF = system.file("dev/data/faceAllYear.csv", package = "flowBasedClustering"), nbCore = 4)
...
* ``climate`` : climate file, 2 first columns are Date and Period, others are exogenous variables (e.g. wind speed and temperature)
